...
export function GameBoard() {
  ...
  return (
    ...
    >
      ...
      {(weakenTargeting || destroyTargeting || destroyAnyTargeting || exileAnyTargeting || declDestroyTargeting || buffTargeting || exileAllyDrawTargeting || declExileTargeting) && (
        <div
          className={`absolute top-14 left-1/2 -translate-x-1/2 z-50 bg-slate-900/95 border rounded-full px-4 py-2 flex items-center gap-3 shadow-xl ${
            exileAnyTargeting || exileAllyDrawTargeting || declExileTargeting ? 'border-purple-500/50' : buffTargeting ? 'border-emerald-500/50' : 'border-red-500/50'
          }`}
        >
          <span className={`text-xs font-bold ${exileAnyTargeting || exileAllyDrawTargeting || declExileTargeting ? 'text-purple-300' : buffTargeting ? 'text-emerald-300' : 'text-red-300'}`}>
            {weakenTargeting
              ...
              : declExileTargeting
              ? 'Elige una carta en juego: será desterrada'
